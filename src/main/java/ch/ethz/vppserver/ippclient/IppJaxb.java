...
public class IppJaxb {
  ...
  private final static String TAG_LIST_FILENAME = "ippclient/ipp-list-of-tag.xml";
  private final static String ATTRIBUTE_LIST_FILENAME = "ippclient/ipp-list-of-attributes.xml";
